package pl.pawel.bookee.repository;

import pl.pawel.bookee.BookeeApp;
import pl.pawel.bookee.config.Constants;
import pl.pawel.bookee.config.audit.AuditEventConverter;
import pl.pawel.bookee.domain.PersistentAuditEvent;
...
import static pl.pawel.bookee.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
